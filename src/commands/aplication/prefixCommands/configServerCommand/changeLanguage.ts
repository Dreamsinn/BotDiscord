...
export class ChangeLanguage {
    public async call(
        ...
        const changeLengaugeMessage = await this.createChangeLanguageMessage(event, languagesArray);
    ...
    private async createChangeLanguageMessage(event: Message, languagesArray: UnionToArray<Languages>) {
